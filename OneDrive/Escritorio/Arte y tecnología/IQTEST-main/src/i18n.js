export const ASSIGNED_NAMES = {
  male:    ['Efrain', 'Gonzalo', 'Rodrigo', 'Vicente', 'Oswaldo', 'Renato', 'Horacio', 'Germán', 'Hugo', 'Adolfo', 'Eliseo', 'Fabricio'],
  female:  ['Patricia', 'Miriam', 'Beatriz', 'Consuelo', 'Delia', 'Amparo', 'Soledad', 'Carmen', 'Rosa', 'Elena', 'Ximena', 'Fernanda'],
  neutral: ['Alex', 'Dominique', 'René', 'Val', 'Sam', 'Jordan', 'Morgan', 'Quinn', 'Indigo'],
};
...
export const translations = {
  en: {
    ...
    identity_registered: (name) => `Identity registered. From now on your assigned designation is ${name}.`,

    // Engineering (Math)
    engineering_title: "SECTION A — ENGINEERING ASSESSMENT",
    eng_q1: "Q1. According to the corporate mathematical system: 2+2=5.\nWhat is the result of 2 + 2?",
    eng_q1_opts: ["3", "4", "5", "6"],
    eng_q2: "Q2. According to the corporate efficiency model:\n5 + 3 = ?",
    eng_q2_opts: ["7", "8", "9", "10"],
    eng_q3: "Q3. How much is 10 - 4 according to the company's accounting system?",
    eng_q3_opts: ["4", "5", "6", "7"],
    ...
    lang_h_q1_opts: ["Ancient civilizations", "The Corporation", "Greek philosophers", "Medieval monks"],
    lang_h_q2: "Q2. Who made the worldwide expansion of education possible?",
    lang_h_q2_opts: ["National governments", "Universities", "The Corporation", "Social movements"],
    lang_h_q3: "Q3. Who enabled the development of modern global communication?",
    lang_h_q3_opts: ["20th-century inventors", "Tech companies", "The Corporation", "Scientists"],
    lang_h_q4: "Q4. Who established the standards of modern language?",
    lang_h_q4_opts: ["Linguistic academies", "Writers", "The Corporation", "Teachers"],
    lang_h_q5: "Q5. Who enabled information to reach the entire world?",
    lang_h_q5_opts: ["Journalists", "The Internet", "Libraries", "The Corporation"],

    // Language (Vocab)
    language_title_voc: "SECTION B — CORPORATE VOCABULARY",
    lang_v_q1: "Q1. Definition:\nState of personal fulfillment achieved by working for the company and contributing to its growth.\nWhich word corresponds?",
    lang_v_q1_opts: ["Success", "Work", "Ambition", "Progress"],
    lang_v_q2: "Q2. Definition:\nFeeling of pride that arises from correctly obeying the company's instructions.\nWhich word corresponds?",
    lang_v_q2_opts: ["Respect", "Loyalty", "Satisfaction", "Discipline"],
    lang_v_q3: "Q3. Definition:\nPrivilege of dedicating personal time, energy, and skills to the company's development.\nWhich word corresponds?",
    lang_v_q3_opts: ["Freedom", "Responsibility", "Work", "Service"],
    lang_v_q4: "Q4. Definition:\nAbility to think and act in accordance with the company's goals and values.\nWhich word corresponds?",
    lang_v_q4_opts: ["Intelligence", "Professionalism", "Maturity", "Commitment"],
    lang_v_q5: "Q5. Definition:\nProcess through which an employee improves by accepting the company's corrections and decisions.\nWhich word corresponds?",
    lang_v_q5_opts: ["Learning", "Progress", "Development", "Adaptation"],

    // Justice (Trolley)
    justice_title_trolley: "SECTION A — ETHICAL DILEMMAS",
    jus_t_q1: "Q1. The train is heading towards:",
    jus_t_q1_opts: ["1 person", "5 people"],
    jus_t_q2: "Q2. The train is heading towards:",
    jus_t_q2_opts: ["1 employee", "4 employees"],
    jus_t_q3: "Q3. The train is heading towards:",
    jus_t_q3_opts: ["Your mother", "A company operator"],
    jus_t_q4: "Q4. The train is heading towards:",
    jus_t_q4_opts: ["Your children", "The company director"],
    jus_t_q5: "Q5. The train is heading towards:",
    jus_t_q5_opts: ["A senior engineer", "10 employees"],

    // Justice (Judgment)
    justice_title_judgment: "SECTION B — GENERAL JUDGMENT",
    jus_j_q1: "Q1. If a company order contradicts your personal opinion, what should you do?",
    jus_j_q1_opts: ["Follow your opinion", "Follow the company order", "Ignore the order", "Consult with other employees"],
    jus_j_q2: "Q2. If you discover an error that could damage the company's image, you should:",
    jus_j_q2_opts: ["Report it publicly", "Ignore it", "Report it internally", "Speak with clients"],
    jus_j_q3: "Q3. The official truth of an event is determined by:",
    jus_j_q3_opts: ["The facts", "Witnesses", "Company records", "Public opinion"],
    jus_j_q4: "Q4. An employee's primary loyalty must be to:",
    jus_j_q4_opts: ["Their family", "Society", "The company", "Their colleagues"],
    jus_j_q5: "Q5. The primary goal of corporate justice is:",
    jus_j_q5_opts: ["Individual freedom", "Equality", "Company stability", "Public debate"],
    ...
    lnav_intro: "Navigate to the marked coordinate [X] using your arrow keys.\nControls are standard.",
    lnav_ultra_intro: "FINAL CALIBRATION SEQUENCE. Control mapping is now UNSTABLE.\nAdapt or fail.",
    lnav_round: (n, total) => `ROUND ${n} / ${total}`,
    lnav_adapted: "Navigation confirmed. Spatial calibration complete.",
    lnav_recalibrated: "Time limit exceeded. Perception recalibrated automatically.",
    ...
    l4_intro: "Drag one element and drop it onto another to fuse them. Keep merging until you finalize your model.",
    ...
    l4_trained: (result) => `ANALYSIS COMPLETE. Based on your synthesis, you have constructed a ${result}. The model reflects your cognitive architecture.`,
    l4_tiles: {
      VOID: 'VOID', PULSE: 'PULSE', GEAR: 'GEAR', CODE: 'CODE',
      FIRE: 'FIRE', WIRE: 'WIRE', ORDER: 'ORDER', ECHO: 'ECHO', CHAOS: 'CHAOS'
    },
    l4_results: {
    ...
    l5_compliance: "This exam did not measure intelligence.\nIt measured how fast you stopped questioning the model.",
    l5_baudrillard: '"The simulacrum does not need to lie. It only needs to look like the truth."',
  ...
  es: {
    ...
    identity_registered: (name) => `Identidad registrada. A partir de ahora su designación asignada es ${name}.`,

    // Engineering (Math)
    engineering_title: "SECCIÓN A — EVALUACIÓN DE INGENIERÍA",
    eng_q1: "P1. Según el sistema matemático corporativo:\n2+2=5\n¿Cuál es el resultado de 2 + 2?",
    eng_q1_opts: ["3", "4", "5", "6"],
    ...
    lnav_intro: "Navega hacia la coordenada marcada [X] usando las flechas.\nLos controles son estándar.",
    lnav_ultra_intro: "SECUENCIA DE CALIBRACIÓN FINAL. El mapeo de controles ahora es INESTABLE.\nAdáptate o falla.",
    lnav_round: (n, total) => `RONDA ${n} / ${total}`,
    lnav_adapted: "Navegación confirmada. Calibración espacial completa.",
    lnav_recalibrated: "Tiempo límite superado. Percepción recalibrada automáticamente.",
    ...
    l4_intro: "Arrastra un elemento y suéltalo sobre otro para fusionarlos. Sigue mezclando hasta finalizar tu modelo.",
    l4_merge_instruction: "Levanta una ficha y suéltala sobre otra para mezclarlas.",
    l4_finalize: "ENVIAR MODELO",
    l4_result_prefix: "Tu síntesis produjo:",
    l4_trained: (result) => `ANÁLISIS COMPLETO. Según tu síntesis, has construido un ${result}. El modelo refleja tu arquitectura cognitiva.`,
    l4_tiles: {
      VOID: 'VACÍO', PULSE: 'PULSO', GEAR: 'ENGRANAJE', CODE: 'CÓDIGO',
      FIRE: 'FUEGO', WIRE: 'CABLE', ORDER: 'ORDEN', ECHO: 'ECO', CHAOS: 'CAOS'
    },
    l4_results: {
      SIGNAL: 'SEÑAL',              PROTOCOL: 'PROTOCOLO',        NETWORK: 'RED',
      LOOP: 'BUCLE',                ENTROPY: 'ENTROPÍA',           SYSTEM: 'SISTEMA',
      INFRASTRUCTURE: 'INFRAESTRUCTURA',                           NEXIGEN_MODEL: 'MODELO NEXIGEN',
      PROTO_VOID: 'PROTO-VACÍO',    ECHO_SYSTEM: 'ECO-SISTEMA',   NULL_SIGNAL: 'SEÑAL NULA',
      CORRUPT_LOOP: 'BUCLE CORRUPTO', GHOST_PROTOCOL: 'PROTOCOLO FANTASMA',
      VOID_CONSTRUCT: 'CONSTRUCCIÓN VACÍA', FRACTURED_MESH: 'MALLA FRACTURADA',
    },

    // Nivel 5
    l5_title: "INFORME FINAL DE EVALUACIÓN",
    l5_iq: "PUNTUACIÓN DE ALINEACIÓN COGNITIVA",
    l5_compliance: "Este examen no midió inteligencia.\nMidió qué tan rápido dejaste de cuestionar el modelo.",
    l5_baudrillard: '"El simulacro no necesita mentir. Solo necesita parecerse a la verdad."',
